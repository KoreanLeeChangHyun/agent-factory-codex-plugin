...
SECTIONED_DOCUMENT = (
    PLUGIN_ROOT / "skills" / "factory-lifecycle" / "assets" / "scripts"
...
class ArtifactManagerScriptContractTests(unittest.TestCase):
    ...
    def test_canonical_artifact_skills_require_their_owning_scripts(self) -> None:
        contracts = {
            ...
            "work-unit-manager": "assets/scripts/work_unit.py",
        }
    ...
    def test_shared_contract_requires_script_only_fail_closed_management(
        ...
        paths = [
            PLUGIN_ROOT / "skills" / "factory-lifecycle" / "SKILL.md",
            (
                PLUGIN_ROOT
                / "skills"
                / "factory-lifecycle"
    ...
    def test_plugin_has_no_artifact_authoring_hooks_or_hook_contract(self) -> None:
        ...
        contract_paths = [
            ...
            PLUGIN_ROOT / "skills" / "work-unit-manager" / "SKILL.md",
            PLUGIN_ROOT / "skills" / "factory-lifecycle" / "SKILL.md",
            (
                PLUGIN_ROOT
                / "skills"
