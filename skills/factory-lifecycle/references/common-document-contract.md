...
- `work-unit-manager/assets/profiles/work-unit.profile.json` owns Work Unit
  sections.
- `factory-lifecycle/assets/schema/sectioned-document/` owns the shared title,
...
- `factory-lifecycle/assets/schema/document-profile.schema.json` validates the
...
`work-unit-manager/assets/scripts/work_unit.py`. This is a hard precondition,
