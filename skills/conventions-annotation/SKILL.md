---
name: conventions-annotation
description: Enforce the Agent Factory code comment, documentation comment, and TODO annotation convention. Use whenever Codex creates, changes, reviews, or refactors source annotations.
---
