...
- Resolve the destination through `synchronization/scripts/sync.py` before any copy,
...
- Use `synchronization/scripts/sync.py` to inspect or set project overrides; do not edit
