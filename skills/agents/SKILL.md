---
name: agents
description: Run the Human-facing Main Agent or a resumable Inquiry Agent through the Agent Factory session runtime.
---
...
`<project-root>/.agent-factory/sessions/`.
...
- `references/main.md`: Collect Human feedback, dispatch fast Work Agents, return results, and start post-feedback Recording Agents.
