...
Only these five large categories and their order are decided. The Human has not
yet defined any Activity's Primary Sidebar information architecture, detailed
capabilities, internal hierarchy, controls, metrics, or source contract. Until
those decisions exist, each sidebar and workspace view must state that its
