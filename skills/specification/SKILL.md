---
name: specification
description: Create, edit, redesign, inspect, or verify refined Agent Factory Specifications and project-scoped Project Skills when the Human explicitly requests that document work. Do not use for raw Inquiry material, ordinary project implementation, or operational Agent records.
---
...
Keep Inquiry working material, refined Specification output, Project Skills,
and managed Agent session state in their separate locations. Do not silently
promote Inquiry material, recreate retired schema/profile/manager machinery,
