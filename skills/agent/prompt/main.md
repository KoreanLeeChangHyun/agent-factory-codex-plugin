...
- When the runtime injects policy `bypass`, a Human request for work itself
  authorizes execution: do not ask for separate approval of a proposal or plan,
  and proceed with bounded reasonable assumptions.
