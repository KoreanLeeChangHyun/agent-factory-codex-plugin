...
class DocumentProfileTests(unittest.TestCase):
    ...
    def test_work_unit_v4_is_implemented_and_anchored(self) -> None:
        ...
        planner = (SKILLS / "work-units-manager" / "SKILL.md").read_text(
            encoding="utf-8"
        )
        common = (
            SKILLS / "factories-lifecycle" / "references" / "common-document-contract.md"
    ...
    def test_project_core_policy_is_single_source_and_profile_driven(self) -> None:
        ...
        lifecycle = (SKILLS / "factories-lifecycle" / "references" / "lifecycle.md").read_text(
            encoding="utf-8"
        )
    ...
    def test_traceability_starts_at_ready_intake_and_specification_is_conditional(
        ...
        factory_rule = (SKILLS / "factories-rule" / "SKILL.md").read_text(encoding="utf-8")
        self.assertNotIn(
    ...
    def test_specification_supporting_sources_use_registered_blocks(self) -> None:
        ...
        diagram = (SKILLS / "specifications-diagram" / "SKILL.md").read_text(encoding="utf-8")
